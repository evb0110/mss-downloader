...
export type TLibrary = 'nypl' | 'morgan' | 'gallica' | 'grenoble' | 'karlsruhe' | 'manchester' | 'unifr' | 'e_manuscripta' | 'vatlib' | 'cecilia' | 'irht' | 'dijon' | 'laon' | 'durham' | 'sharedcanvas' | 'saint_omer' | 'ugent' | 'bl' | 'loading' | 'florus' | 'unicatt' | 'cudl' | 'trinity_cam' | 'toronto' | 'isos' | 'mira' | 'orleans' | 'rbme' | 'parker' | 'manuscripta' | 'internet_culturale' | 'graz' | 'cologne' | 'vienna_manuscripta' | 'rome' | 'berlin' | 'czech' | 'modena' | 'bdl' | 'monte_cassino' | 'vallicelliana' | 'verona' | 'europeana' | 'diamm' | 'bne' | 'belgica_kbr' | 'mdc_catalonia' | 'bvpb' | 'onb' | 'rouen' | 'freiburg';
