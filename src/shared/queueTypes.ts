...
export type TLibrary = 'nypl' | 'morgan' | 'gallica' | 'grenoble' | 'karlsruhe' | 'manchester' | 'unifr' | 'e_manuscripta' | 'vatlib' | 'cecilia' | 'irht' | 'dijon' | 'laon' | 'durham' | 'sharedcanvas' | 'saint_omer' | 'ugent' | 'bl' | 'bodleian' | 'loading' | 'florus' | 'unicatt' | 'cudl' | 'trinity_cam' | 'toronto' | 'fulda' | 'isos' | 'mira' | 'orleans' | 'rbme' | 'parker' | 'manuscripta' | 'internet_culturale' | 'graz' | 'gams' | 'cologne' | 'vienna_manuscripta' | 'rome' | 'roman_archive' | 'berlin' | 'czech' | 'modena' | 'bdl' | 'monte_cassino' | 'vallicelliana' | 'omnes_vallicelliana' | 'verona' | 'europeana' | 'diamm' | 'bne' | 'mdc_catalonia' | 'bvpb' | 'onb' | 'rouen' | 'freiburg' | 'wolfenbuettel' | 'florence' | 'hhu' | 'loc' | 'vatican' | 'bordeaux' | 'linz' | 'e_rara' | 'yale';
