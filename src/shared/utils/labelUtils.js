...
exports.isGenericLabel = isGenericLabel;
exports.enhanceManuscriptLabel = enhanceManuscriptLabel;
function isGenericLabel(label) {
    ...
    return genericTerms.some(term => normalizedLabel === term ||
        normalizedLabel.startsWith(term + ' ') ||
        normalizedLabel.endsWith(' ' + term));
}
function enhanceManuscriptLabel(options) {
