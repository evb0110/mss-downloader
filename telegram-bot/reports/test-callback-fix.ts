...
class CallbackFixTester {
    ...
    async testMenuDuplication(): Promise<void> {
        ...
        try {
            ...
            console.error('❌ Menu duplication test failed:', errorMessage);
        }
    }
    ...
    async testCallbackDeduplication(): Promise<void> {
        ...
        try {
            ...
            const errorMessage = error instanceof Error ? error.message : String(error);
            console.error('❌ Callback deduplication test failed:', errorMessage);
        }
    }
    ...
    async testSubscriptionFlow(): Promise<void> {
        ...
        try {
            ...
            const errorMessage = error instanceof Error ? error.message : String(error);
            console.error('❌ Subscription flow test failed:', errorMessage);
        }
    }
