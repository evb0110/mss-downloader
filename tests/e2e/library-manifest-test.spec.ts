...
test.describe('Library Manifest Testing', () => {
  test('test manifest loading for all major libraries', async ({ page }) => {
    ...
    const testLibraries = [
      ...
      { name: 'Cambridge University Digital Library', url: 'https://cudl.lib.cam.ac.uk/view/MS-DD-00004-00015/1' },
      { name: 'Trinity College Cambridge', url: 'https://mss-cat.trin.cam.ac.uk/manuscripts/uv/view.php?n=MS.B.1.21' },
      { name: 'Dublin ISOS (DIAS)', url: 'https://www.isos.dias.ie/english/index.html?manuscript=MS_23_P_01' },
    ];
