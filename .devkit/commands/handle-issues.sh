...
echo ""
echo "🚨 CRITICAL LIBRARY ADDITION RULE 🚨"
echo "- If issue requests new library → IMPLEMENT IMMEDIATELY"
echo "- NEVER say 'will be added later' or 'принято к рассмотрению'"
echo "- DO IT NOW: Create loader → Test → Deploy → Update user"
echo ""
echo "CRITICAL RULES:"
...
echo "- LIBRARY REQUESTS = IMMEDIATE IMPLEMENTATION (not deferral)"
echo ""
