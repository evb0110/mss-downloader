...
const VALIDATION_DIR = path.join(__dirname, '../validation-results/graz');
const PDF_DIR = path.join(VALIDATION_DIR, 'pdfs');

// Test URLs from GitHub issue #2
const TEST_URLS = [
    'https://unipub.uni-graz.at/obvugrscript/content/titleinfo/8224538',
    'https://unipub.uni-graz.at/obvugrscript/content/titleinfo/3339540',
...
async function validateGraz() {
    console.log('=== Graz University Validation ===\n');
    ...
    for (const url of TEST_URLS) {
        ...
        try {
            ...
            if (imageFiles.length > 0) {
                // Create PDF
                const pdfPath = path.join(PDF_DIR, `graz_${manuscriptId}.pdf`);
    ...
    const report = {
        ...
        issue: 'GitHub Issue #2 - Manifest addition error',
        results,
        summary: {
...
// Run validation
validateGraz().catch(console.error);