...
app.whenReady().then(async () => {
  try {
    ...
    console.log('Loading manifest for: https://bdh.bne.es/bnesearch/detalle/006003');
    const manifest = await downloader.loadManifest('https://bdh.bne.es/bnesearch/detalle/006003');
