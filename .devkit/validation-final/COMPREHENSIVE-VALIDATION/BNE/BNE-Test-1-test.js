...
app.whenReady().then(async () => {
  try {
    ...
    console.log('Loading manifest for: https://bdh.bne.es/bnesearch/detalle/007619');
    const manifest = await downloader.loadManifest('https://bdh.bne.es/bnesearch/detalle/007619');
