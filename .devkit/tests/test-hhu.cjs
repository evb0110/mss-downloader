...
async function testHhu() {
    ...
    try {
        ...
        const url = 'https://digital.ulb.hhu.de/ms/content/titleinfo/7674176';
        ...
        console.log(`\nhhu test completed in ${elapsed} seconds`);
        
    } catch (error) {
        console.error(`hhu test failed:`, error.message);
