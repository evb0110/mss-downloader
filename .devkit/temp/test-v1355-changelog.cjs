...
// Test the fixed changelog generation logic with v1.3.55 commit
...
// Test with the actual v1.3.55 commit message
const testCommit = "VERSION-1.3.55: Fix University of Graz timeouts, add Rome BNC libroantico support, resolve Manuscripta.at hanging downloads, and fix e-manuscripta.ch complete manuscript detection";

console.log("Testing changelog generation for v1.3.55:");
...
console.log("✅ Fixed University of Graz loading timeouts");
console.log("✅ Added Rome BNC libroantico collection support");
console.log("✅ Fixed Manuscripta.at hanging downloads");